<?php
/* === Class Library - mpc_datacleaner ======================================== *
 * Copyright (c) 020 Mootly Obviate - See /LICENSE.md
 * --- Revision History ------------------------------------------------------- *
 * 2020-06-29 | Page created.
 * ---------------------------------------------------------------------------- */
...
$mpo_parts->h1_title          = 'mpc_datacleaner';
$mpo_parts->link_title        = 'mpc_datacleaner';
