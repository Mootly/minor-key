...
<dl class="clamshell">
  ...
  <dd>
    ...
    <dt>Return the path to an asset</dt>
    <dd>
      <pre><var>array</var> = $mpo_instance-&gt;get_asset( <var>string</var> type, <var>string</var> name [, <var>bool</var> embed=false] );</pre>
      <p>This method is used to determined where an asset lives for inclusion. It checks the paths in the following order:</p>
      <ul>
        <li>template <code>_assets</code> folder</li>
        <li>root <code>_assets</code> folder</li>
      </ul>
        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              <ul>
                <li><b>content</b> =&gt; 'htm,html,inc,php,txt'</li>
                <li><b>document</b> =&gt; 'doc,docx,dot,dotx,rtf,pdf,pps,ppt,pptx,xls,xlsm,xlsx,xlt,xltm,xltx'</li>
                <li><b>image</b> => 'jpg,jpeg,gif,png,svg'</li>
                <li><b>script</b> => 'js'</li>
                <li><b>style</b> => 'css'</li>
                <li><b>video</b> => 'avi,mov,mp4,mpg,mpeg,wmv,sbv,srt,sub,vtt'</li>
                <li><b>widget</b> => 'inc,php,asp,aspx,cfm,cfml'</li>
              </ul>
            </td>
          </tr>
          <tr>
            <th>name</th>
            <td>
              <p>The name of the file to be pathed. Including the suffix is optional, but recommended for images. If the suffix is included, it msut match the type as above.</p>
            </td>
          </tr>
          <tr>
            <th>embed</th>
      ...
      <dt>Return the contents of a static widget</dt>
      <dd>
        ...
        <ul>
          <li>template <code>_assets/widgets/</code> folder</li>
          <li>template <code>_assets/php_widgets/</code> folder</li>
          <li>root <code>_assets/widgets/</code> folder</li>
          <li>root <code>_assets/php_widgets/</code> folder</li>
        </ul>
        <p>These paths may be changed in the <b>init</b> process.</p>
        <p>On a successful hit it will stop searching. Templates always override root.</p>
