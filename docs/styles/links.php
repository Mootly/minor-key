...
$mpo_scripts->demo_helpers    = '/_assets/es/demo-helpers.min.js';
...
<h2 class="show-size-el">Floated Image Box</h2>
...
<section>
  <figure class="figure video-box show-size-vid">
...
mpf_renderPage($mpo_parts->template.$mpt_['default'].$mpt_['suffix'], $mpo_parts, $mpo_scripts);
?>
